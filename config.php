...
define("APP_ID", "fe2432819c226de693cd7de9149362cc");

// Application Default Color (Mostly Used By Mobile)
define("META_THEME_COLOR", "#FF8000");
...
define("META_DESCRIPTION", "sistema de inventario");
...
define("DB_NAME", "sistemas_inventariodb");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id_usuario'] : null ));
