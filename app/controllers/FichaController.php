...
class FichaController extends SecureController{
	...
	function view($rec_id = null, $value = null){
		...
		$fields = array("ficha.id", 
			...
			"enviado.creacion AS enviado_creacion", 
			"recibido.id_recibido AS recibido_id_recibido", 
			"recibido.fecha_recibido AS recibido_fecha_recibido", 
			"recibido.lugar_recibido AS recibido_lugar_recibido", 
			"recibido.png AS recibido_png", 
			"recibido.creacion AS recibido_creacion", 
			"centro.Tel_centro AS centro_Tel_centro", 
			"centro.id_centro AS centro_id_centro", 
			"centro.numero_centro AS centro_numero_centro", 
			"centro.direccion_centro AS centro_direccion_centro", 
			"centro.Nombre_centro AS centro_Nombre_centro", 
			"centro.fecha_creacion AS centro_fecha_creacion", 
			"detalle_registro.id_detalle_registro AS detalle_registro_id_detalle_registro", 
			"detalle_registro.fk_registro AS detalle_registro_fk_registro", 
			"detalle_registro.fk_producto AS detalle_registro_fk_producto", 
			"detalle_registro.fk_cantidad AS detalle_registro_fk_cantidad", 
			"detalle_registro.desc_detalle AS detalle_registro_desc_detalle", 
			...
			"producto.fecha_creacion AS producto_fecha_creacion", 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("fecha","fk_emisor","fk_receptor");
