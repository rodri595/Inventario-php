<?php 
/**
 * Registro Page Controller
 * @category  Controller
 */
class RegistroController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("registro.id_registro", ORDER_TYPE);
		}
		if($fieldname){
		...
		$page_title = $this->view->page_title = get_lang('registro');
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("registro/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		return $this->render_view("registro/view.php", $record);
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("registro.id_registro", $rec_id);;
		...
		$page_title = $this->view->page_title = get_lang('edit_registro');
		if(!$data){
			$this->set_page_error();
		}
		return $this->render_view("registro/edit.php", $data);
	}
	/**
     * Update single field
	 * @param $rec_id (select record by table primary key)
	...
	function delete($rec_id = null){
		...
		$db->where("registro.id_registro", $arr_rec_id, "in");
