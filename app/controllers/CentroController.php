<?php 
/**
 * Centro Page Controller
 * @category  Controller
 */
class CentroController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$this->view->search_template = "centro/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("centro.id_centro", ORDER_TYPE);
		}
		if($fieldname){
		...
		$this->render_view("centro/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("centro.id_centro", $rec_id);; //select record based on primary key
		}
		...
		return $this->render_view("centro/view.php", $record);
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		return $this->render_view("centro/edit.php", $data);
	}
	/**
     * Update single field
	 * @param $rec_id (select record by table primary key)
	...
	function delete($rec_id = null){
		...
		$db->where("centro.id_centro", $arr_rec_id, "in");
