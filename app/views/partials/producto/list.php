...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('productos'); ?></h4>
                </div>
                <div class="col-sm-3 ">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("producto/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        <?php print_lang('crear_producto'); ?> 
                    </a>
                </div>
                <div class="col-sm-4 ">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  <?php echo (get_value('orderby')=='nombre_producto' ? 'class="sortedby td-nombre_producto"' : null); ?>>
                                                    <?php Html :: get_field_order_link('nombre_producto', get_lang('_producto')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='desc_producto' ? 'class="sortedby td-desc_producto"' : null); ?>>
                                                    <?php Html :: get_field_order_link('desc_producto', get_lang('descripci_n')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='cantidad_producto' ? 'class="sortedby td-cantidad_producto"' : null); ?>>
                                                    <?php Html :: get_field_order_link('cantidad_producto', get_lang('cantidad')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='peso_producto' ? 'class="sortedby td-peso_producto"' : null); ?>>
                                                    <?php Html :: get_field_order_link('peso_producto', get_lang('peso')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='dimension_producto' ? 'class="sortedby td-dimension_producto"' : null); ?>>
                                                    <?php Html :: get_field_order_link('dimension_producto', get_lang('dimensiones')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='precio_producto' ? 'class="sortedby td-precio_producto"' : null); ?>>
                                                    <?php Html :: get_field_order_link('precio_producto', get_lang('precio')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='fk_proveedor' ? 'class="sortedby td-fk_proveedor"' : null); ?>>
                                                    <?php Html :: get_field_order_link('fk_proveedor', get_lang('proveedor')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='fk_categoria' ? 'class="sortedby td-fk_categoria"' : null); ?>>
                                                    <?php Html :: get_field_order_link('fk_categoria', get_lang('categoria')); ?>
                                                </th>
