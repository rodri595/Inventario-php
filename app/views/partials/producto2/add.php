                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-desc_producto"  value="<?php  echo $this->set_field_value('desc_producto',""); ?>" type="text" placeholder="<?php print_lang('enter_desc_producto'); ?>"  required="" name="desc_producto"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-cantidad_producto"  value="<?php  echo $this->set_field_value('cantidad_producto',""); ?>" type="text" placeholder="<?php print_lang('enter_cantidad_producto'); ?>"  required="" name="cantidad_producto"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="input-group">
                                                                                <input id="ctrl-fecha_ultima_update" class="form-control datepicker  datepicker" required="" value="<?php  echo $this->set_field_value('fecha_ultima_update',""); ?>" type="datetime"  name="fecha_ultima_update" placeholder="<?php print_lang('enter_fecha_ultima_update'); ?>" data-enable-time="true" data-min-date="" data-max-date="" data-date-format="Y-m-d H:i:S" data-alt-format="F j, Y - H:i" data-inline="false" data-no-calendar="false" data-mode="single" /> 
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-isdeleted"  value="<?php  echo $this->set_field_value('isdeleted',""); ?>" type="text" placeholder="<?php print_lang('enter_isdeleted'); ?>"  required="" name="isdeleted"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
