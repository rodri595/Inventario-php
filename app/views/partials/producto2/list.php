...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('producto2'); ?></h4>
                </div>
                <div class="col-sm-3 ">
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("producto2/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        <?php print_lang('add_new_producto2'); ?> 
                    </a>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('producto2'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('producto2'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-desc_producto"> <?php print_lang('desc_producto'); ?></th>
                                                <th  class="td-cantidad_producto"> <?php print_lang('cantidad_producto'); ?></th>
                                                <th  class="td-peso_producto"> <?php print_lang('peso_producto'); ?></th>
                                                <th  class="td-dimension_producto"> <?php print_lang('dimension_producto'); ?></th>
                                                <th  class="td-fk_proveedor"> <?php print_lang('fk_proveedor'); ?></th>
                                                <th  class="td-fk_categoria"> <?php print_lang('fk_categoria'); ?></th>
                                                <th  class="td-fecha_creacion"> <?php print_lang('fecha_creacion'); ?></th>
                                                <th  class="td-fecha_ultima_update"> <?php print_lang('fecha_ultima_update'); ?></th>
                                                <th  class="td-fecha_delete"> <?php print_lang('fecha_delete'); ?></th>
                                                <th  class="td-isdeleted"> <?php print_lang('isdeleted'); ?></th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id_producto"><a href="<?php print_link("producto2/view/$data[id_producto]") ?>"><?php echo $data['id_producto']; ?></a></td>
                                                    ...
                                                    <td class="td-fecha_ultima_update">
                                                        <span  data-flatpickr="{ minDate: '', maxDate: ''}" 
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="<?php print_lang('view_record'); ?>" href="<?php print_link("producto2/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> <?php print_lang('view'); ?>
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="<?php print_lang('edit_this_record'); ?>" href="<?php print_link("producto2/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i> <?php print_lang('edit'); ?>
                                                        </a>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="<?php print_lang('delete_this_record'); ?>" href="<?php print_link("producto2/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <button data-prompt-msg="<?php print_lang('are_you_sure_you_want_to_delete_these_records_'); ?>" data-display-style="modal" data-url="<?php print_link("producto2/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
