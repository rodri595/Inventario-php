...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('add_new_registro2'); ?></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="registro2-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("registro2/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-lugar_enviado"  value="<?php  echo $this->set_field_value('lugar_enviado',""); ?>" type="number" placeholder="<?php print_lang('enter_lugar_enviado'); ?>" step="1"  required="" name="lugar_enviado"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-lugar_recibido"  value="<?php  echo $this->set_field_value('lugar_recibido',""); ?>" type="text" placeholder="<?php print_lang('enter_lugar_recibido'); ?>"  required="" name="lugar_recibido"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
