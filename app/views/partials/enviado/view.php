...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('reporte_de_movimiento_enviado'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_enviado">
                                        <th class="title"> <?php print_lang('id_enviado'); ?>: </th>
                                        <td class="value"> <?php echo $data['id_enviado']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-lugar_salida">
                                        <th class="title"> <?php print_lang('lugar_salida'); ?>: </th>
                                        <td class="value">
