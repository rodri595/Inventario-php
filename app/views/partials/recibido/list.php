                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('recibido'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  <?php echo (get_value('orderby')=='fecha_recibido' ? 'class="sortedby td-fecha_recibido"' : null); ?>>
                                                    <?php Html :: get_field_order_link('fecha_recibido', get_lang('fecha_recibido')); ?>
                                                </th>
                                                <th  <?php echo (get_value('orderby')=='lugar_recibido' ? 'class="sortedby td-lugar_recibido"' : null); ?>>
                                                    <?php Html :: get_field_order_link('lugar_recibido', get_lang('lugar_recibido')); ?>
                                                </th>
