...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('reporte_de_movimiento_recibido'); ?></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        $counter = 0;
                        if(!empty($data)){
                        $rec_id = (!empty($data['id_recibido']) ? urlencode($data['id_recibido']) : null);
                        $counter++;
                        ?>
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_recibido">
                                        <th class="title"> <?php print_lang('id_recibido'); ?>: </th>
                                        <td class="value"> <?php echo $data['id_recibido']; ?></td>
                                    </tr>
                                    <tr  class="td-fecha_recibido">
                                    ...
                                    <tr  class="td-lugar_recibido">
                                        ...
                                        <td class="value">
                                            <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("centro/view/" . urlencode($data['lugar_recibido'])) ?>">
                                                <i class="fa fa-building-o "></i> <?php echo $data['centro_Nombre_centro'] ?>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr  class="td-png">
                                        <th class="title"><i class="fa fa-file-image-o "></i> <?php print_lang('png'); ?>: </th>
                                        <td class="value"><?php Html :: page_img($data['png'],400,400,1); ?></td>
                                    </tr>
                                    <tr  class="td-creacion">
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("recibido/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> <?php print_lang('edit'); ?>
                                                </a>
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("recibido/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
